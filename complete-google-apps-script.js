// Complete Google Apps Script Code - Copy this to your Google Apps Script project
...
function doPost(e) {
	try {
		...
		// Option 2: If script is bound to spreadsheet (uncomment if using this method)
